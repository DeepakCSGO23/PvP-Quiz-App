...
export default function Header() {
  ...
  return (
    <header className="relative flex flex-col h-32 font-roboto justify-center bg-[#86B1A8]">
      ...
      <div
        className={`absolute top-0 right-0 flex flex-col items-center justify-start z-10 h-screen space-y-10 duration-500 ${
          ...
          <div className="flex flex-col space-y-6">
            <Link to="/profile">
              <div className="flex space-x-2">
                ...
                <button className="text-gray-200 hover:text-white w-20 text-left">
                  Profile
                </button>
              </div>
            </Link>
